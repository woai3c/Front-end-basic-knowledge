...
* [假设定义了一个数组a=[1,2,3]，相应的，页面上显示的值为1,2,3，现设a[0]=5，页面上的值会变成5,2,3吗？为什么？](#假设定义了一个数组a%3D%5B1%2C2%2C3%5D，相应的，页面上显示的值为1%2C2%2C3，现设a%5B0%5D%3D5，页面上的值会变成5%2C2%2C3吗？为什么？)
